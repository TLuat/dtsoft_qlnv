        ...
        <table class="w-full text-sm text-gray-500 dark:text-gray-400">
          ...
          <tbody class="text-black text-center">
            <tr class="bg-white border-b dark:border-gray-700 hover:bg-gray-50">
              <td class="px-5 text-left border border-slate-300">1</td>
              <td class="text-center font-medium border border-slate-300">KH001</td>
              ...
              <td class="px-3 py-4 font-medium whitespace-nowrap border border-slate-300">
                <a class="text-blue-800" href="chitietkehoach.php">
                    ...
                    <div class="relative w-full max-w-md max-h-full">
                      <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="p-6 text-center">
                          ...
                          <h3 class="mb-5 text-lg font-normal">Xóa kế hoạch này sự này?</h3>
