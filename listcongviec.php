    ...
    <div class="mb-4">
      <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
          <div class="p-4 mt-14 grid">
            <div class="justify-self-end">
              <a href="addcongviec.php" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
        ...
        <table class="w-full text-sm text-gray-500 dark:text-gray-400">
          ...
          <tbody class="text-black text-center">
            <tr class="bg-white border-b dark:border-gray-700 hover:bg-gray-50">
              ...
              <td class="text-center">Công việc 1</td>
              ...
              <td class="px-3 py-4 font-medium whitespace-nowrap">
                <a href="editcongviec.php" class="ms-auto text-dark cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top">Sửa |
                  <a href="#" class="ms-auto text-dark cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top">Xóa
              </td>
            </tr>
          </tbody>
        </table>
