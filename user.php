...
// session_start();
  ...
  // AND nguoidung.id_vaitro NOT IN ('QTHT') ";
  $sql = "SELECT n.*, v.tenvaitro, b.tenbophan, b.cvchuyenmon, k.tenkhuvuc FROM nguoidung n INNER JOIN vaitro v ON n.id_vaitro = v.id_vaitro
  INNER JOIN khuvuc k ON n.id_khuvuc = k.id_khuvuc
  LEFT JOIN bophan b ON n.id_bophan = b.id_bophan
  WHERE n.id_vaitro NOT IN ('QTHT') ";
  ...
  <div class="p-4 mt-14">
    ...
    <div class="p-4 mt-14 grid">
      ...
      <div class="justify-self-end">
        <a href="themuser.php" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
            ...
            <tbody class="text-black text-center">
              ...
              ?>
                <tr class="bg-white border-b dark:border-gray-700 hover:bg-gray-50">
                  ...
                  <td class="px-3 py-4 font-medium whitespace-nowrap border border-slate-300 text-center">
                    <a class="text-blue-800" href="chinhsuauser.php?action=sua&idnhansu=<?php echo $row['id_nguoidung']  ?>">
